...
public String username ="";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(409, 57, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Age", "Mobile Number", "Address", "Username", "Password"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 145, 806, 397));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("Click on row to delete User");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(327, 560, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 10, 50, 40));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        while(rs.next())
        {
        model.addRow(new Object[]{rs.getString("ID"),rs.getString("name"),rs.getString("dob"),rs.getString("Phone"),rs.getString("Address"), rs.getString("username"),rs.getString("password")});
        }
        }
        catch(Exception e)
        {
